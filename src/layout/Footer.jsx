...
const Footer = () => {
    ...
    const handleEmailCopyClick = () => {
        ...
        setTimeout(() => {
            emailContentRef.current.textContent = 'albertking1103@gmail.com';
        }, 3000);
    };
    ...
    return (
                        ...
                        <div className={styles.footer_row_left}>
                            <div className={styles.profile_container}>
                                <div className={styles.self_img_container}>
                                    <img src={selfDescentPic} alt="Heinrich portrait image" />
                                </div>
                                <div
                            ...
                            >
                                ...
                                <li style={{ '--index': 3 }}>
                                    <a
                                        href="https://github.com/seniordev68"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    >
                                        <svg
		...
		C72.834,60.054,69.171,64.043,64.531,64.043z"
                            ...
                            <div className={styles.mail_btns_container}>
                                ...
                                >
                                    <span ref={emailContentRef}>albertking1103@gmail.com</span>
                    ...
                    <div className={styles.footer_column}>
                        <div className={styles.copyright_container}>
                            <p className="body_text_200">
                                &copy; {new Date().getFullYear()}, designed and built by Foretich.
                            </p>
                        </div>
                    </div>
                </div>
