                    ...
                    <div className={styles.skills_section_row}>
                        ...
                        <div className={styles.skills_content_container}>
                            <p className="body_text_500">
                                ...
                                Express.js, and command in CSS, JavaScript, and React, Vue, Angular.
                            </p>
                            <p className="body_text_500">
                                Besides being a Frontend Developer and a Full-stack developer, I also
                                enjoy video editing and crafting web designs.
                            </p>
                            <p className="body_text_500">
                                Over the last 6 years, I've shared my coding, teaching, web
