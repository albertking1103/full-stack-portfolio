...
const Hero = ({ doubleViewportScrollCompleted }) => {
    ...
    const handleCTACopyClick = () => {
        ...
        setTimeout(() => {
            ctaEmailContentRef.current.textContent = 'albertking1103@gmail.com';
        }, 3000);
    };
                ...
                <div className={`section_container ${styles.hero_section_container}`}>
                    ...
                    >
                        ...
                        <p className={`body_text_500 ${styles.hero_intro_paragraph}`}>
                            I’m a <span className="word_highlight_1">FullStack</span>{' '}
                            developer, <span className="word_highlight_1">Frontend Developer</span> as
                            well as a <span className="word_highlight_1">Backend Developer</span>. And I
                            might have a thing for others and{' '}
